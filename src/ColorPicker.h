...
public:
    ...
    public:
        ...
        Format& fullScreen( bool fullScreen = true ) { mFullScreen = fullScreen; return *this; }
        Format& sensitivity( float sensitivity ) { mSensitivity = sensitivity; return *this; }
        Format& relative( float relative = true ) { mRelative = relative; return *this; }
        Format& rgb() { mColorModel = ci::ColorModel::CM_RGB; return *this; }
        Format& hsv() { mColorModel = ci::ColorModel::CM_HSV; return *this; }
        Format& alpha( const glm::vec2 &limits = glm::vec2( -1.0, 1.0 ) ) { mAlphaLimits = limits; return *this; }
    protected:
        FontSize mFontSize;
        bool mLabel;
        Alignment mAlign;
    ...
    virtual void setCallback( const std::function<void(ci::ColorA)> &callback );
