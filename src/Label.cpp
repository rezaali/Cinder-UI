...
Label::Label( string name, string label, FontSize fontSize ) : Control(), mLabel(label), mFontSize(fontSize), mShadowOffset(vec2(0.5, 0.5)), mColorShadow(ColorShadow), mDrawShadow(false)
