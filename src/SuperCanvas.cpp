...
SuperCanvas::SuperCanvas( std::string title ) : Canvas( title ), mDeltaTime(0.35f), mLastHitTime(-1), mIsMinified(false), mLabelHit(false), mHitPos(vec2(0,0)), mLastPos(vec2(0,0)), mLabelRef(nullptr) { }
