...
public:
    ...
    public:
        ...
        Format& trigger( Trigger trigger ) { mTrigger = trigger; return *this; }
        Format& autoClear( bool autoClear = true ) { mAutoClear = autoClear; return *this; }
        Format& numeric( bool numeric = true ) { mNumeric = numeric; return *this; }
    protected:
        bool mNumeric;
        bool mAutoClear;
        Trigger mTrigger;
