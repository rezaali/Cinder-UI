...
Control::Control() : View(), mState(State::NORMAL), mTrigger(Trigger::ALL), mKeyHit(false), mKeyModifier(-1), mDrawBounds(false), mDrawBoundsOutline(false), mDrawBack(true), mDrawFill(true), mDrawFillHighlight(false), mDrawOutline(true), mDrawOutlineHighlight(false), mColorClear(ColorClear), mColorBounds(ColorBounds), mColorBoundsOutline(ColorBoundsOutline),mColorBack(ColorBack), mColorOutline(ColorOutline), mColorOutlineHighlight(ColorOutlineHighlight), mColorFill(ColorFill), mColorFillHighlight(ColorFillHighlight) { }
